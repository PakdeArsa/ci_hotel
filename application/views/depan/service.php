<article id="content">
    <div class="box1">
        <div class="wrapper">
            ...
            <div class="col2 pad">
                <h2><img src="<?= base_url('assets/front/'); ?>images/title_marker1.jpg" alt="">Featured Services</h2>
                <div class="wrapper pad_bot2">
                    <figure class="left marg_right1"><img src="<?= base_url('assets/front/'); ?>images/page2_img1.jpg" alt=""></figure>
                ...
                <div class="wrapper">
                    <figure class="left marg_right1"><img src="<?= base_url('assets/front/'); ?>images/page2_img2.jpg" alt=""></figure>
    ...
    <div class="pad">
        <div class="wrapper line3">
            ...
            <div class="col1 pad_left1">
                ...
                <div class="wrapper">
                    <figure class="left marg_right1"><img src="<?= base_url('assets/front/'); ?>images/page2_img3.jpg" alt=""></figure>
                ...
                <div class="wrapper">
                    <figure class="left marg_right1"><img src="<?= base_url('assets/front/'); ?>images/page2_img4.jpg" alt=""></figure>
