        ...
        <div class="wrapper">
            ...
            <div class="kwicks-wrapper marg_bot1">
                <ul class="kwicks horizontal">
                    <li><img src="<?= base_url('assets/front/'); ?>images/img1.jpg" alt=""></li>
                    <li><img src="<?= base_url('assets/front/'); ?>images/img2.jpg" alt=""></li>
                    <li><img src="<?= base_url('assets/front/'); ?>images/img3.jpg" alt=""></li>
                    <li><img src="<?= base_url('assets/front/'); ?>images/img4.jpg" alt=""></li>
                </ul>
            </div>
        </div>
        <div class="pad">
            <div class="line1">
                <div class="wrapper line2">
                    <div class="col1">
                        <h2><img src="<?= base_url('assets/front/'); ?>images/title_marker1.jpg" alt="">Best Rates</h2>
                    ...
                    <div class="col1 pad_left1">
                        <h2><img src="<?= base_url('assets/front/'); ?>images/title_marker2.jpg" alt="">Hotel Guide</h2>
                    ...
                    <div class="col1 pad_left1">
                        <h2><img src="<?= base_url('assets/front/'); ?>images/title_marker3.jpg" alt="">Packages</h2>
    ...
    <div class="pad">
        <div class="wrapper line3">
            ...
            <div class="col1 pad_left1">
                <h2>About Us</h2>
                <div class="wrapper">
                    <figure class="left marg_right1"><img src="<?= base_url('assets/front/'); ?>images/page1_img1.jpg" alt=""></figure>
