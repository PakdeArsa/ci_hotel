<article id="content">
    <div class="box1">
        <div class="wrapper">
            ...
            <div class="col2 pad">
                <h2><img src="<?= base_url('assets/front/'); ?>images/title_marker1.jpg" alt="">Best Propositions of This Month</h2>
                <div class="wrapper line1">
                    <div class="col3">
                        <figure class="pad_bot3"><img src="<?= base_url('assets/front/'); ?>images/page3_img1.jpg" alt=""></figure>
                    ...
                    <div class="col3 pad_left2">
                        <figure class="pad_bot3"><img src="<?= base_url('assets/front/'); ?>images/page3_img4.jpg" alt=""></figure>
                        <p class="pad_bot1"><strong class="color3">Lorem ipsum dolor amet consectetur</strong></p>
    ...
    <div class="pad">
        <div class="wrapper line3">
            <div class="col2">
                ...
                <div class="wrapper">
                    <figure class="left marg_right1"><img src="<?= base_url('assets/front/'); ?>images/page3_img3.jpg" alt=""></figure>
